          ...
          <div className='navbar-end space-x-5'>
            ...
            <div className='hidden md:block'>
              <label className="px-3 py-2 border rounded-md flex items-center gap-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="" className="h-4 w-4 opacity-70">
            ...
            <div className={`app ${isNightMode ? "night-mode" : "day-mode"}`}>
              <label className="swap swap-rotate">
                <input type="checkbox" onChange={toggleNightMode} checked={isNightMode}  />
                {/* Sun Icon */}
            ...
            <div className="md:pl-7">
              <a className="bg-black rounded-md p-2 hover:bg-red-600 cursor-pointer duration-300 text-white" onClick={() => document.getElementById("my_modal_3").showModal()}>Login</a>
              <Login />
            </div>
          </div>
        </div>
